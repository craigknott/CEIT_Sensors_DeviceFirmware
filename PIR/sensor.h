...
// PIR SENSOR
#ifdef PIR
#define PIN_PIR           8    // Digital Pin
#define PIN_PWRPIR        9    // Digital Pin
#define pirSensorON();    digitalWrite(PIN_PWRPIR, HIGH);
#define pirSensorOFF();   digitalWrite(PIN_PWRPIR, LOW);
#endif
