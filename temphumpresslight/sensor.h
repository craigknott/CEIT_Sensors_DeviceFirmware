...
#define LIGHT  1         // Light Sensor (TEMT6000)
...
// LIGHT SENSOR
#ifdef LIGHT
#define PIN_ADCLHT        0    // Analog Pin
#define PIN_PWRLHT        9    // Digital Pin
#define lhtSensorON();    digitalWrite(PIN_PWRLHT, HIGH);
#define lhtSensorOFF();   digitalWrite(PIN_PWRLHT, LOW);
#endif
