...
// SPL SENSOR
#ifdef SPL
#define PIN_ADCSPL        5    // Analog Pin
#define PIN_PWRSPL        7    // Digital Pin
#define splSensorON();    digitalWrite(PIN_PWRSPL, HIGH);
#define splSensorOFF();   digitalWrite(PIN_PWRSPL, LOW);
#endif
